...
$stmt_producto = $pdo->prepare("
    SELECT p.id_producto, p.nombre, p.sabor, p.descripcion, p.precio, p.stock, p.activo, p.id_proveedor,
...
<head>
    ...
    <title>Editar Producto - Concelato Gelateria</title>
        ...
        <header class="admin-header">
            <div class="header-content">
                <div class="logo">
                    ...
                    Concelato Gelateria - Editar Producto
                </div>
                <nav>
                    <ul>
                ...
                <form method="POST" class="producto-form">
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="sabor" name="sabor" value="<?php echo htmlspecialchars($producto['sabor']); ?>" required>
                        </div>
                    </div>
